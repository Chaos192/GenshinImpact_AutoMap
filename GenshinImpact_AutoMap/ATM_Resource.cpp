...
{
	hGIOBJICON = new HBITMAP[11];//OBJ
	hGIOBJICONMASK = new HBITMAP[11];//OBJ
	...
	GIOBJICON = new Mat[11];//OBJ
	GIOBJICONMASK = new Mat[11];//OBJ
...
void ATM_Resource::loadGiObjIcon()
{
	...
	hGIOBJICON[3] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON93));
	HBitmap2Mat(hGIOBJICON[3], GIOBJICON[3]);
	hGIOBJICON[4] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON94));
	HBitmap2Mat(hGIOBJICON[4], GIOBJICON[4]);
	hGIOBJICON[5] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON101));
	HBitmap2Mat(hGIOBJICON[5], GIOBJICON[5]);
	hGIOBJICON[6] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON102));
	HBitmap2Mat(hGIOBJICON[6], GIOBJICON[6]);
	hGIOBJICON[7] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON103));
	HBitmap2Mat(hGIOBJICON[7], GIOBJICON[7]);
	hGIOBJICON[8] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON104));
	HBitmap2Mat(hGIOBJICON[8], GIOBJICON[8]);
	hGIOBJICON[9] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON105));
	HBitmap2Mat(hGIOBJICON[9], GIOBJICON[9]);
	hGIOBJICON[10] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON205));
...
void ATM_Resource::loadGiObjIconMask()
{
	...
	hGIOBJICONMASK[3] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON93MASK));
	HBitmap2Mat(hGIOBJICONMASK[3], GIOBJICONMASK[3]);
	Mat2MaskMat(GIOBJICONMASK[3], GIOBJICONMASK[3]);
	hGIOBJICONMASK[4] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON94MASK));
	HBitmap2Mat(hGIOBJICONMASK[4], GIOBJICONMASK[4]);
	Mat2MaskMat(GIOBJICONMASK[4], GIOBJICONMASK[4]);
	hGIOBJICONMASK[5] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON101MASK));
	HBitmap2Mat(hGIOBJICONMASK[5], GIOBJICONMASK[5]);
	Mat2MaskMat(GIOBJICONMASK[5], GIOBJICONMASK[5]);
	hGIOBJICONMASK[6] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON102MASK));
	HBitmap2Mat(hGIOBJICONMASK[6], GIOBJICONMASK[6]);
	Mat2MaskMat(GIOBJICONMASK[6], GIOBJICONMASK[6]);
	hGIOBJICONMASK[7] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON103MASK));
	HBitmap2Mat(hGIOBJICONMASK[7], GIOBJICONMASK[7]);
	Mat2MaskMat(GIOBJICONMASK[7], GIOBJICONMASK[7]);
	hGIOBJICONMASK[8] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON104MASK));
	HBitmap2Mat(hGIOBJICONMASK[8], GIOBJICONMASK[8]);
	Mat2MaskMat(GIOBJICONMASK[8], GIOBJICONMASK[8]);
	hGIOBJICONMASK[9] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON105MASK));
	HBitmap2Mat(hGIOBJICONMASK[9], GIOBJICONMASK[9]);
	Mat2MaskMat(GIOBJICONMASK[9], GIOBJICONMASK[9]);
	hGIOBJICONMASK[10] = LoadBitmap(GetModuleHandle(0), MAKEINTRESOURCE(IDB_OBJICON205MASK));
